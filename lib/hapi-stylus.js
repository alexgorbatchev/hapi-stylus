...
register = function(plugin, arg, next) {
  var cache, compress, ending, handler, home, linenos, prefix, route, use;
  route = arg.route, home = arg.home, compress = arg.compress, cache = arg.cache, ending = arg.ending, linenos = arg.linenos, prefix = arg.prefix, use = arg.use;
